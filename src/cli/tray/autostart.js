...
const APP_NAME = "NProuter";
const APP_LABEL = "com.NProuter.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when nprouter is currently
 ...
 * SIGTERM to the running process. When the running nprouter cli.js was itself
...
<dict>
    ...
    <string>/tmp/nprouter.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/nprouter.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `nprouter.cmd` lookup that depended on the npm prefix path.
