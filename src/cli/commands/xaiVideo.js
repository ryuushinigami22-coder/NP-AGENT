/**
 * `nprouter xai video` — generate a Grok Imagine video through the local
 * nprouter gateway and save the result as an MP4 file.
 *
...
const HELP = `
Usage: NProuter xai video --prompt "..." [options]

Generate a Grok Imagine video via your local NProuter gateway
...
Options:
  ...
  --api-key <key>         NProuter API key (or env NINE_ROUTER_API_KEY)
...
async function run(argv) {
  ...
  try {
    ...
    const connectionId = create.headers["x-NProuter-connection-id"] || null;
