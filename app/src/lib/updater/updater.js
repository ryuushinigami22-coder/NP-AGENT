...
const packageName = process.env.UPDATER_PKG_NAME || "nprouter";
...
function getDataDir() {
  ...
  if (process.platform === "win32") {
    return path.join(process.env.APPDATA || path.join(os.homedir(), "AppData", "Roaming"), "nprouter");
  }
  return path.join(os.homedir(), ".nprouter");
}
